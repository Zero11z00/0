...
sub_client.kick(userId:("\033[1;93m# userid : \033[0m") , chatId:("\033[1;93m# your email : \033[0m"), allowRejoin: bool = True)=amino.SubClient(userId: str, chatId: str, allowRejoin: bool = True)
